...
RSpec.describe TasksController, type: :controller do
  ...
  describe 'GET index' do
    it 'should assign all tasks to @tasks' do
      tasks = Task.create(title:"Monday", content:"Wear new clothes", deadline:"2018-12-22 08:11:00")
      get :index
  ...
  describe "GET show" do
    it "should assign task to @task" do
      task = Task.create(title:"Wednesday", content:"Mountaineering", deadline:"2018-12-22 08:11:00")  
